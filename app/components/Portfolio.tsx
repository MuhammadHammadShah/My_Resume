...
export const Portfolio = () => {
  return (
    <div
      className=" items-center max-w-7xl mx-auto leading-8 mb-10"
      id="Portfolio"
    >
      ...
      <div className=" grid sm:grid-cols-2 md:grid-cols-3 gap-20 mx-auto w-full">
        ...
        {/* Card_1 ends from here  */}

        {/* Card_2 starts from here */}
        ...
        {/* Card_2 ends here here */}

        {/* Card_3 starts from here */}
        <div className=" shadow-md shadow-gray-400  h-60 hover:scale-105 duration-75">
          <div>
            <img
              src="https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aHVtYW58ZW58MHx8MHx8&w=1000&q=80"
        ...
        {/* Card_3 ends here here */}

        {/* Card_4 starts from here */}
        <div className=" shadow-md shadow-gray-400  h-60 hover:scale-105 duration-75">
          <div>
            <img
              src="https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aHVtYW58ZW58MHx8MHx8&w=1000&q=80"
        ...
        {/* Card_4 ends here here */}

        {/* Card_5 starts from here */}
        <div className=" shadow-md shadow-gray-400  h-60 hover:scale-105 duration-75">
          <div>
            <img
              src="https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aHVtYW58ZW58MHx8MHx8&w=1000&q=80"
        ...
        {/* Card_5 ends here here */}

        {/* Card_6 starts from here */}
        <div className=" shadow-md shadow-gray-400  h-60 hover:scale-105 duration-75">
          <div>
            <img
              src="https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aHVtYW58ZW58MHx8MHx8&w=1000&q=80"
